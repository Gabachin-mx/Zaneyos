...
in with lib; {
  wayland.windowManager.hyprland = {
	...
	bind = ${modifier},W,exec,${browser}
      ...
      bind = ${modifier},R,exec,kitty -e ranger
      bind = ${modifier},M,exec,spotify
      bind = ${modifier},K,exec,kitty
      bind = ${modifier},A,exec,alacritty
      ...
      bind = ALT,K,exec, kitty -e zellij
      bind = ALT,A,exec, alacritty -e zellij
      bind = ALT,T,exec, kitty -e tmux
      bind = ALT,Q,exec, qbittorrent
      bind = ALT,E,exec, easyeffects
      # bind = ALTSHIFT,F,exec, firefox
     bind = ALT,B,exec, ~/.local/bin/rofi-bluetooth
      bind = ALT,P,exec, ~/.local/bin/logout.sh
